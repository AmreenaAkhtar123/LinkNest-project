  ...
  return (
    ...
    <div className="flex justify-center flex-col ml-[10vw] gap-3">
      ...
      <div className="input flex gap-2">
        <input value={text} onChange={(e)=> setText(e.target.value)} className="text-gray-600 px-2 py-2 focus:outline-green-800 rounded-md bg-white" type="text" placeholder="Enter your Handle" />
        <button onClick={()=> createTree()} className="bg-pink-300 rounded-full px-4 py-4 font-semibold text-black">Claim your Bittree</button>
      </div>
    </div>
